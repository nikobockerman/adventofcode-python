...
def find_first_and_last_int(input: str) -> tuple[str, str]:
    first: str | None = None
    last: str | None = None
...
def p1_ints(lines: Iterable[str]) -> Iterable[int]:
    for line in lines:
        logging.debug(f"{line=}")
        value = int_chars_to_int(*find_first_and_last_int(line))
